# -*- coding: utf-8 -*-
"""
Created on Wed Aug 19 10:18:59 2020
...
def plotting(names):
    ...
    for name in names:
        ...
        plt.subplot(2,1,1)
        plt.title("A_multB_matmul_llena")
...
names = ["A_multB_matmul_llena0.txt","A_multB_matmul_llena1.txt","A_multB_matmul_llena2.txt","A_multB_matmul_llena3.txt","A_multB_matmul_llena4.txt"]
plotting(names)
