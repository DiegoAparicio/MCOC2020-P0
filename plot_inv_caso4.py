# -*- coding: utf-8 -*-
"""
Created on Wed Aug 12 14:26:54 2020
...
data = sp.loadtxt("datos3_corrida10.txt")
...
plt.subplot(2,1,1)
plt.title("Rendimiento np.longdouble")
plt.loglog(N, dts.T, "-o")
plt.legend(['scipy False', 'scipy True'],loc="upper left")
